...
LANGUAGE_CODE = 'en-us'       # You can also use 'en' for general English
TIME_ZONE = 'Asia/Karachi'    # Pakistan Standard Time (UTC+5)
USE_I18N = True               # Enable internationalization
USE_L10N = True               # Enable localized formatting of numbers/dates
USE_TZ = True                 # Store datetimes in UTC and convert to TIME_ZONE
